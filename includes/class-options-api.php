...
class Options_API {
	...
	public static function init() {
		Hook_Registry::add_action( 'wp_ajax_nopriv_' . self::FILTER_PREFIX . '_tag_search', array( __CLASS__, 'tags_search' ) );
		Hook_Registry::add_action( 'wp_ajax_' . self::FILTER_PREFIX . '_tag_search', array( __CLASS__, 'tags_search' ) );
	}
