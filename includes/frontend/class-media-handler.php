...
class Media_Handler {
	 ...
	 */
	protected static $prefix = 'wherego';
	 ...
	 * @var string
	 */
	protected static $default_thumb_url = WHEREGO_PLUGIN_URL . 'default.png';
	 ...
	 *
	 * Calls {@see wherego_get_option()} directly. Subclasses for other plugins
	...
	protected static function get_option( string $key, $fallback = null ) {
		return wherego_get_option( $key, $fallback );
	}
