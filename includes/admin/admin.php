...
function wherego_add_admin_pages_links() {
	...
	$wherego_settings_page = add_options_page( esc_html__( 'WebberZone Followed Posts', 'where-did-they-go-from-here' ), esc_html__( 'WebberZone Followed Posts', 'where-did-they-go-from-here' ), 'manage_options', 'wherego_options_page', 'wherego_options_page' );
